    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) {
                ...
                document.addEventListener("click", (function(e) {
                    if ("menu__body" !== !e.target.className) document.classList.remove("menu-open");
                }));
            }
        }
        function menuClose() {
        ...
        function initSliders() {
            if (document.querySelector(".body-main-slider__swiper")) new core(".body-main-slider__swiper", {
                ...
                on: {
                    init: function() {
                        ...
                        controll.forEach((function(el, index) {
                            let num = 0;
                            if (index < 10) el.innerHTML = `${num}${index + 1}`; else el.innerHTML = `${index + 1}`;
                        }));
                    },
                    breakpoint: function(swiper, info) {
                        !info.autoHeight ? document.querySelector(".body-main__wrapper").style.height = "auto" : "";
                        swiper.updateSize();
                    }
                }
            });
        ...
        window.addEventListener("load", (function(e) {
            ...
            const picker = datepicker_min("[data-calendar]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
                customMonths: [ "Январь", "Фебраль", "Март", "Апрель", "Май", "Юнь", "Июль", "Август", "Сентябрь ", "октябрь", "ноябрь", "декабрь" ],
                overlayPlaceholder: "Ввести год"
            });
            picker.calendarContainer.style.setProperty("font-size", "1.4rem"), picker.calendarContainer.style.setProperty("font-family", "Cormorant Upright");
        }));
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
